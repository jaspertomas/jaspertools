...
/**
 * sfUserEmailAddress filter form base class.
 *
 * @package    filters
 * @subpackage sfUserEmailAddress *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BasesfUserEmailAddressFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sf_user_email_address_filters[%s]');
