...
/**
 * sfUserImAccountType filter form base class.
 *
 * @package    filters
 * @subpackage sfUserImAccountType *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BasesfUserImAccountTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sf_user_im_account_type_filters[%s]');
